...
namespace Digital_Excellence
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			{
				o.UseSqlServer(Config.OriginalConfiguration.GetConnectionString("DefaultConnection"), sqlServerOptionsAction: sqlOptions =>
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			app.UseWhen(context =>
				...
				|| context.Request.Method.Equals(HttpMethods.Put)) && context.User.Identities.Any(i => i.IsAuthenticated),
			appBuilder =>
			{
