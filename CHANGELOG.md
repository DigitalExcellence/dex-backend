...
- ElasticSearch (including project to synchronize our database with Elastic) to function as a recommendation system. - [#63](https://github.com/DigitalExcellence/dex-backend/issues/63)
