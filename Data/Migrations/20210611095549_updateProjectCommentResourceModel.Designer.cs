...
namespace _4_Data.Migrations
{
    ...
    [Migration("20210611095549_updateProjectCommentResourceModel")]
    partial class updateProjectCommentResourceModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ProjectComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.ProjectCommentLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Models.ProjectCommentLike", b =>
                {
                    b.HasOne("Models.ProjectComment", "LikedComment")
                        .WithMany("Likes")
                        .HasForeignKey("LikedCommentId");

                    b.HasOne("Models.User", "CommentLiker")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
