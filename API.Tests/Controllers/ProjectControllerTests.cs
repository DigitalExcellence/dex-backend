...
namespace API.Tests.Controllers
{
    public class ProjectControllerTests : BaseTests
    {
            ...
            HttpStatusCode expectedResult)
        {
            ...
            HttpResponseMessage response = await AuthClient.GetAsync(".well-known/openid-configuration");
            //HttpResponseMessage response = await TestClient2.GetAsync("https://localhost:5001/api/project");
            // Assert
