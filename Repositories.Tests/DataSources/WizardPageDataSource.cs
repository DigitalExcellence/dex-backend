...
namespace Repositories.Tests.DataSources
{
    ...
    /// <summary>
    ///     This class is an attribute used for generating wizard pages.
    /// </summary>
    [AttributeUsage(AttributeTargets.Parameter)]
    public class WizardPageDataSource : Attribute, IParameterDataSource
    {

        private readonly int amountToGenerate;

        private readonly IFakeDataGenerator<WizardPage> fakeDataGenerator;

        /// <summary>
        ///     Initializes WizardPageDataSourceAttribute.
        /// </summary>
        public WizardPageDataSource()
        {
            fakeDataGenerator = new WizardPageDataGenerator();
        }
        ...
        public IEnumerable GetData(IParameterInfo parameter)
        {
            ...
            List<WizardPage> options = fakeDataGenerator.GenerateRange(amountToGenerate)
                                                                .ToList();
            return new[] {options};
        }
