...
namespace API.Resources
{
    ...
    public class UserOutput
    {
        ...
        /// </summary>
        public List<UserProjectOutput> UserProject { get; set; }

        /// <summary>
        ///     Gets or sets the liked projects by registered users.
        /// </summary>
        public List<UserProjectLikeOutput> LikedProjectsByUsers { get; set; }

        /// <summary>
        ///     Gets or set the tasks the user should follow up.
        /// </summary>
        public List<UserTaskOutput> UserTask { get; set; }
