...
namespace Services.Tests
{
    ...
    public class HighlightServiceTest : ServiceTest<Highlight, HighlightService, IHighlightRepository>
    {
        ...
        {
            RepositoryMock.Setup(repository => repository.GetHighlightsAsync())
                          .Returns(Task.FromResult(highlights));
        ...
        /// <summary>
        ///     Test whether the repository method is called and no changes have been applied to the object assuming no highlights
        ///     were provided
        /// </summary>
        /// <returns></returns>
        [Test]
        ...
        /// <summary>
        ///     Test whether the repository method is called if no project is provided and no changes have been applied to the
        ///     object assuming no highlights were provided
        /// </summary>
