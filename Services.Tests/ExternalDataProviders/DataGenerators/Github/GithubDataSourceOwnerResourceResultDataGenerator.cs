...
namespace Services.Tests.ExternalDataProviders.DataGenerators.Github
{
    ...
    /// <summary>
    ///     FakeDataGenerator for a GithubDataSourceOwnerResourceResult
    /// </summary>
    public class GithubDataSourceOwnerResourceResultDataGenerator
        : FakeDataGenerator<GithubDataSourceOwnerResourceResult>
    {
        ...
        /// </summary>
        public GithubDataSourceOwnerResourceResultDataGenerator()
        {
            Faker = new Faker<GithubDataSourceOwnerResourceResult>()
